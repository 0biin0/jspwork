...
<body>
	...
	<p>
		학원명 : ${academy }<br> 강의장 : ${classRoom }<br> 강사명 :
		${teacher.name }, ${teacher.age }, ${teacher.gender }<br> 수강생 정보
		:
	<ul>
	...
	<br> requestScope에 담긴 값 : ${requestScope.scope }
	<br> sessionScope에 담긴 값 : ${sessionScope.scope }
	<br> applicationScope에 담긴 값 : ${applicationScope.scope }
	<br>
	<!-- 값을 안담았으므로 아무것도 출력되지 않음 -->
