...
<body>
    ...
    그냥 출력 : ${num1 }<br>
    세자리마다 구분하여 출력 : <fmt:formatNumber value="${num1 }" /><br> <!--  groupingUsed을 안쓰면 기본값 true == 세자리마다 구분자 있음 -->
    ...
    <ul>
    	...
    	<li>Medium : <fmt:formatDate value="${cDate }" type="both" dateStyle="medium" timeStyle="long" />
    	<li>long : <fmt:formatDate value="${cDate }" type="both" dateStyle="long"  timeStyle="long" />
    	<li>Full : <fmt:formatDate value="${cDate }" type="both" dateStyle="full"  timeStyle="full" />
    	<li>short : <fmt:formatDate value="${cDate }" type="both" dateStyle="short"  timeStyle="short" />
